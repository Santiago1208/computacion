...
public class Cliente implements Serializable {
	...
	public String getCliHabilitado() {
		return this.cliHabilitado;
	}

	public void setCliHabilitado(String cliHabilitado) {
		this.cliHabilitado = cliHabilitado;
	}
